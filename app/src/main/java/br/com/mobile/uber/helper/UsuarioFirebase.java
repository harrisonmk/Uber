...
import br.com.mobile.uber.activity.PassageiroActivity;
import br.com.mobile.uber.activity.RequisicoesActivity;
import br.com.mobile.uber.config.ConfiguracaoFirebase;
import br.com.mobile.uber.model.Usuario;

public class UsuarioFirebase {

    //Metodo para recuperar o usuario atual "Retorna o objeto inteiro"
    ...
    //Metodo para redirecionar o usuario
    public static void redirecionaUsuarioLogado(final Activity activity){

        FirebaseUser user = getUsuarioAtual();
        if(user != null ){
            Log.d("resultado", "onDataChange: " + getIdentificadorUsuario());
            DatabaseReference usuariosRef = ConfiguracaoFirebase.getFirebaseDatabase().child("usuarios").child( getIdentificadorUsuario() );
    ...
    //Metodo para retornar apenas o Id daquele usuario
